...
async function salvarFilmeFavorito(filme: Filme): Promise<boolean> {
  ...
  /* Verifica se um filme já existe com o mesmo id na lista/storage de favoritos. A função some() retorna true se encontrar pelo mesmo 1 item que satisfaça a condição. */
