...
- Definindo alias/apelido para os caminhos (tsconfig.js)
...
- Ajusste do layout do FlatList para modo de 2 colunas (grid)
...
- Criação da versão básicas das telas `Busca` e `Resultados`
